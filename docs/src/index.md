...
We strive for minimal dependencies (listed in `Project.toml`), consisting of: `Dierckx`, `Ephemerides`, `ForwardDiff`, `FrameTransformations`, `Interpolations`, `LinearAlgebra`, `OrdinaryDiffEq`, `SPICE`, `Symbolics`.
