...
function dfdx_NbodySH_Interp_fd(x, u, params, t)
    return eom_jacobian_drag_safe(HighFidelityEphemerisModel.eom_NbodySH_Interp, x, u, params, t)
end
...
function eom_stm_NbodySH_Interp_fd!(dx_stm, x_stm, params, t)
    ...
    A = eom_jacobian_drag_safe(eom_NbodySH_Interp, x_stm[1:6], 0.0, params, t)
